...
class TestUtils:
    ...
    def test_location_get_elevation(self, mocked_location):
        elevation = get_elevation_for_location(
            mocked_location.latitude,
            mocked_location.longitude
        )
...
class TestOpenAQDownload:
        ...
        df_dict = {
            ...
            'parameters': {22: [{'id': 7189,
                                ...
                                {'id': 29138,
                                 'unit': 'µg/m³',
                                 'count': 30815,
                                 'average': 20.4211909784196,
                                 'lastValue': 3,
                                 'parameter': 'o3',
                                 'displayName': 'O₃ mass',
                                 'lastUpdated': '2021-01-28T00:00:00+00:00',
                                 'parameterId': 3,
                                 'firstUpdated': '2018-01-07T00:00:00+00:00'}
                                ]
                           },
        ...
        ds_dict = {
            ...
            'data_vars': {
                'no2': {
                    ...
                    'attrs': {'units': 'microgram / m^3',
                              'standard_name': 'no2',
                              'long_name': 'Nitrogen dioxide'},
                    'data': [[48, 43, 52, 60, 28, 26, 32, 27, 30, 30, 21, 26, 137, 0, 0,
                              0, 0, 0, 0, 0]]
                }
            }
        }
    ...
    def test_openaq_download_method__get_closest_stations(
        ...
        assert stations["sensorType"] == "reference grade"
