...
class InceptionTime:
    ...
    def _set_callbacks(self):
        logger.info(
            "Two callbacks have been added to the model fitting: "
    ...
    def predict(
        self, X: pd.DataFrame, filename: Union[Path, str] = None
    ) -> pd.DataFrame:
    ...
    def reshape_data(
        ...
        if aux_values.size:
            ...
            logger.info(
                "The input data is contains only temporal features (air quality"
                " variables)."
            )
